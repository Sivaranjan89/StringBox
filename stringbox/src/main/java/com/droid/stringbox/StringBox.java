...
public class StringBox {
    private static String DATABASE_NAME = "stringbox";
    ...
    //Edit a row in a specific table
    ...
    //Get all the rows of a specific column
